...
# The cluster displacement is drawn via rand_move! and applied with move/rev, so the
# checker can also certify point-group (D4) equivariance of this VMMC variant.
